...
package net.kislay.goasat.sip.core.useragent;
...
import net.kislay.goasat.media.Echo;
import net.kislay.goasat.media.MediaManager;
import net.kislay.goasat.media.MediaMode;
import net.kislay.goasat.media.SoundManager;
import net.kislay.goasat.sdp.SDPManager;
import net.kislay.goasat.sip.Utils;
import net.kislay.goasat.sip.core.useragent.handlers.ByeHandler;
import net.kislay.goasat.sip.core.useragent.handlers.CancelHandler;
import net.kislay.goasat.sip.core.useragent.handlers.InviteHandler;
import net.kislay.goasat.sip.core.useragent.handlers.OptionsHandler;
import net.kislay.goasat.sip.core.useragent.handlers.RegisterHandler;
...
import net.kislay.goasat.sip.transport.SipMessage;
