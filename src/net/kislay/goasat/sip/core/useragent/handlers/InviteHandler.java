...
import net.kislay.goasat.sdp.MediaDestination;
import net.kislay.goasat.sdp.NoCodecException;
import net.kislay.goasat.sdp.SessionDescription;
import net.kislay.goasat.sip.RFC3261;
import net.kislay.goasat.sip.Utils;
import net.kislay.goasat.sip.core.useragent.RequestManager;
import net.kislay.goasat.sip.core.useragent.SipListener;
import net.kislay.goasat.sip.core.useragent.UserAgent;
import net.kislay.goasat.sip.syntaxencoding.NameAddress;
...
import net.kislay.goasat.sip.syntaxencoding.SipURI;
import net.kislay.goasat.sip.syntaxencoding.SipUriSyntaxException;
import net.kislay.goasat.sip.transaction.ClientTransaction;
import net.kislay.goasat.sip.transaction.ClientTransactionUser;
import net.kislay.goasat.sip.transaction.InviteClientTransaction;
import net.kislay.goasat.sip.transaction.InviteServerTransaction;
import net.kislay.goasat.sip.transaction.ServerTransaction;
import net.kislay.goasat.sip.transaction.ServerTransactionUser;
import net.kislay.goasat.sip.transaction.Transaction;
import net.kislay.goasat.sip.transaction.TransactionManager;
import net.kislay.goasat.sip.transactionuser.Dialog;
import net.kislay.goasat.sip.transactionuser.DialogManager;
import net.kislay.goasat.sip.transport.MessageSender;
