...
package net.kislay.goasat.sip.transport;

import static net.kislay.goasat.sip.RFC3261.DEFAULT_SIP_VERSION;
import static net.kislay.goasat.sip.RFC3261.IPV4_TTL;
import static net.kislay.goasat.sip.RFC3261.PARAM_MADDR;
import static net.kislay.goasat.sip.RFC3261.PARAM_TTL;
import static net.kislay.goasat.sip.RFC3261.TRANSPORT_DEFAULT_PORT;
import static net.kislay.goasat.sip.RFC3261.TRANSPORT_PORT_SEP;
import static net.kislay.goasat.sip.RFC3261.TRANSPORT_SCTP;
import static net.kislay.goasat.sip.RFC3261.TRANSPORT_TCP;
import static net.kislay.goasat.sip.RFC3261.TRANSPORT_TLS_PORT;
import static net.kislay.goasat.sip.RFC3261.TRANSPORT_UDP;
import static net.kislay.goasat.sip.RFC3261.TRANSPORT_UDP_USUAL_MAX_SIZE;
import static net.kislay.goasat.sip.RFC3261.TRANSPORT_VIA_SEP;
import static net.kislay.goasat.sip.RFC3261.TRANSPORT_VIA_SEP2;
...
import net.kislay.goasat.Config;
...
import net.kislay.goasat.sip.syntaxencoding.SipHeaderParamName;
import net.kislay.goasat.sip.syntaxencoding.SipHeaders;
import net.kislay.goasat.sip.syntaxencoding.SipParser;
